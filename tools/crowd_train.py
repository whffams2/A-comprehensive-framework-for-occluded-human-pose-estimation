...
def main():
    ...
    adj, adj_ext_1, adj_ext_2, adj_ext_3 = adj_mx_from_skeleton_crowd(cfg.GCN.Crowd_EDGE, cfg.GCN.Crowd_ext_1,
                                                                      cfg.GCN.Crowd_ext_2, cfg.GCN.Crowd_ext_3)
    gcn = eval('models.' + cfg.MODEL.NAME + '.get_gcn_net')(
        cfg, adj, adj_ext_1, adj_ext_2, adj_ext_3, is_train=True
    )
    ...
    gcn_optimizer = torch.optim.Adam(gcn.parameters(), lr=cfg.GCN.LR)
    ...
    if cfg.AUTO_RESUME and os.path.exists(checkpoint_file):
        ...
        gcn_optimizer.load_state_dict(checkpoint['gcn_optimizer'])
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        if ((epoch) % cfg.TEST.INTERVAL == 0 or cfg.TRAIN.END_EPOCH == (epoch + 1)):
            ...
            save_checkpoint({
                ...
                'best_gcn_state_dict': gcn.module.state_dict(),
                'perf': perf_indicator,
                'optimizer': optimizer.state_dict(),
                'gcn_optimizer': gcn_optimizer.state_dict()
            }, best_model, final_output_dir)

        # if cfg.TRAIN.END_EPOCH == (epoch + 1):
        #     validate(
        #         cfg, valid_loader, valid_dataset, model, gcn, criterion,
        #         final_output_dir, tb_log_dir, writer_dict
        #     )
