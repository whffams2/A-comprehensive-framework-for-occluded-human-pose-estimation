...
def adj_mx_from_skeleton(EDGES, ext_1, ext_2, ext_3):
    num_joints = 17
    edges = []
    ext_edges_1 = []
    ext_edges_2 = []
    ...
    for i in range(num_joints):
        for j in range(len(EDGES[i])):
            if EDGES[i][j] > -1:
                edges.append(tuple([i, EDGES[i][j]]))
        for j in range(len(ext_1[i])):
            if ext_1[i][j] > -1:
                ext_edges_1.append(tuple([i, ext_1[i][j]]))
        for j in range(len(ext_2[i])):
            if ext_2[i][j] > -1:
                ext_edges_2.append(tuple([i, ext_2[i][j]]))
        for j in range(len(ext_3[i])):
            if ext_3[i][j] > -1:
                ext_edges_3.append(tuple([i, ext_3[i][j]]))
    ...
    return adj, adj_ext_1, adj_ext_2, adj_ext_3


def adj_mx_from_skeleton_crowd(EDGES, ext_1, ext_2, ext_3):
    num_joints = 14
    edges = []
    ext_edges_1 = []
    ext_edges_2 = []
