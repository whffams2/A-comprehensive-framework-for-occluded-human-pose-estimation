...
class MMGCN_ALL_cp(nn.Module):
    ...
    def __init__(self, adj, adj_ext1, adj_ext2, adj_ext3, skeleton_graph, hid_dim,output_joints, heatmap_size, non_local=False, coords_dim=(2, 2),
        ...
        super(MMGCN_ALL_cp, self).__init__()
...
class PoseHighResolutionNetSemCp(nn.Module):

    def __init__(self, cfg, **kwargs):
        self.inplanes = 64
        extra = cfg['MODEL']['EXTRA']
        super(PoseHighResolutionNetSemCp, self).__init__()
...
def get_pose_net(cfg, is_train, **kwargs):
    model = PoseHighResolutionNetSemCp(cfg, **kwargs)
...
def get_gcn_net(cfg, adj, adj_ext_1, adj_ext_2, adj_ext_3, is_train, **kwargs):
    model = MMGCN_ALL_cp(adj, adj_ext_1, adj_ext_2, adj_ext_3, skeleton_graph=cfg['GCN']['SKELETON_GRAPH'],
