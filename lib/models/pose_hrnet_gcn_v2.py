...
class PoseHighResolutionNetV2(nn.Module):

    def __init__(self, cfg, **kwargs):
        self.inplanes = 64
        extra = cfg['MODEL']['EXTRA']
        super(PoseHighResolutionNetV2, self).__init__()
...
def get_pose_net(cfg, is_train, **kwargs):
    model = PoseHighResolutionNetV2(cfg, **kwargs)
...
def get_gcn_net(cfg, adj, adj_ext_1, adj_ext_2, adj_ext_3, is_train, **kwargs):
    model = MMGCN_V2(adj, adj_ext_1, adj_ext_2, adj_ext_3, skeleton_graph=cfg['GCN']['SKELETON_GRAPH'],
